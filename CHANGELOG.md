...
- **Copa do Mundo 2026**: World Cup matches are also embedded in the schedule page (`/calendario`) via `CopaCalendarSection`, grouped by day with the same "add to Google Agenda" option offered for turmas.
