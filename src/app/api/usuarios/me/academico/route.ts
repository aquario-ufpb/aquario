...
import { privateSigaaResponse, withSigaaBetaOwner } from "@/lib/server/services/sigaa/reauth";
...
export async function GET(request: Request): Promise<Response> {
  try {
    return await withSigaaBetaOwner(request, async (_authenticatedRequest, owner) => {
