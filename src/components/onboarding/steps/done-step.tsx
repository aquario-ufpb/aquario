    ...
    <div className="text-center space-y-8 py-4">
      <div className="flex justify-center">
        <div className="w-16 h-16 rounded-full bg-green-100 dark:bg-green-900/40 flex items-center justify-center">
          <PartyPopper aria-hidden="true" className="w-8 h-8 text-green-600 dark:text-green-400" />
        </div>
      </div>

      <div className="space-y-2">
        <h2 className="text-pretty text-2xl font-bold">Tudo pronto!</h2>
      ...
      <div className="flex flex-col gap-3 max-w-sm mx-auto">
        {profileHref && (
          <Link
            ...
            className="flex min-h-11 touch-manipulation items-center gap-3 rounded-lg border p-4 text-left transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 motion-reduce:transition-none"
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-aquario-primary/10 flex-shrink-0">
              <User aria-hidden="true" className="w-5 h-5 text-aquario-primary" />
            </div>
        ...
        >
          ...
          <ArrowRight aria-hidden="true" className="w-4 h-4 text-muted-foreground flex-shrink-0" />
        </Link>
      </div>
