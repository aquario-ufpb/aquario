  ...
  return (
    <main className="relative">
        ...
        <div className="relative flex flex-col md:flex-row items-center h-full w-full max-w-7xl mx-auto pl-0 pr-8 md:pr-12 pt-24">
          ...
          <div className="flex-1 relative w-full md:w-2/3 h-full mb-8 md:mb-0 flex items-center justify-start">
            <div className="relative w-full h-full -ml-8 md:-ml-16">
              ...
              {/* Fish - on top */}
              <div className="relative z-10 w-[120%] h-[120%] -ml-[10%] -mt-[10%]" style={{ 
          ...
          <div className="flex-1 flex flex-col items-end justify-center space-y-4 md:pl-8 text-right">
            <h1 className="font-display text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold leading-tight" style={{ color: isDark ? '#D0EFFF' : '#285A96' }}>
              <span className="block">Sobre o</span>
              <span className="block">Aquário</span>
            </h1>
            
            <p className="text-base md:text-lg leading-relaxed max-w-md" style={{ color: isDark ? '#C8E6FA' : '#0e3a6c' }}>
            ...
            <div className="pt-2">
              ...
              >
                <Link href="https://github.com/ralfferreira/aquario" target="_blank" rel="noopener noreferrer">
                  <Github size={20} />
                  Contribua
                </Link>
              </Button>
      ...
      <div className="space-y-0">
        ...
        {/* Problem Statement */}
        <section className={`w-full p-12 md:py-16 ${
          isDark 
            ? "bg-white/5" 
            : "bg-white"
        }`}>
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-display font-bold mb-10 text-center" style={{ color: isDark ? '#C8E6FA' : '#0e3a6c' }}>
              O Problema que Resolvemos
            </h2>
            <div className="grid md:grid-cols-2 gap-12">
            <div className="relative p-12 md:p-16 rounded-[3rem] overflow-hidden" style={isDark ? { border: '1px solid rgba(208, 239, 255, 0.5)' } : {}}>
              {!isDark && (
                <div className="absolute inset-0 z-0">
                  <Image
                    src="/blur2.svg"
              ...
              <div className="relative z-10">
                <div className="flex justify-center mb-6">
                  <h3 className="text-2xl font-bold px-2 py-1 rounded-lg inline-block" style={{ 
                    color: isDark ? '#FFB3B5' : '#0e3a6c', 
                    backgroundColor: isDark ? 'rgba(229, 108, 110, 0.6)' : 'rgba(229, 108, 110, 0.4)' 
                  }}>
                    Antes do Aquário
                  </h3>
                </div>
              ...
              <div className="relative z-10">
                <div className="flex justify-center mb-6">
                  <h3 className="text-2xl font-bold px-2 py-1 rounded-lg inline-block" style={{ 
                    ...
                    backgroundColor: isDark ? 'rgba(95, 167, 125, 0.6)' : 'rgba(95, 167, 125, 0.4)' 
                  }}>
                    Com o Aquário
                  </h3>
                </div>
        ...
        <section className={`w-full p-12 md:py-16 ${
          ...
          <div className="container mx-auto max-w-6xl">
            <h2 className="text-4xl font-display font-bold mb-12 text-center" style={{ color: isDark ? '#C8E6FA' : '#0e3a6c' }}>
              Funcionalidades
            </h2>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <CardHeader className={feature.status === "available" ? "" : "opacity-40"}>
                  <CardTitle className="text-xl font-bold" style={{ color: isDark ? '#E5F6FF' : '#0e3a6c' }}>{feature.title}</CardTitle>
                  <CardDescription className="mt-2" style={{ color: isDark ? '#C8E6FA' : '#0e3a6c' }}>{feature.description}</CardDescription>
                </CardHeader>
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="grid md:grid-cols-2 gap-6">
              <Card className={`p-8 text-center rounded-3xl ${
                ...
                <CardHeader>
                  <CardTitle className="text-3xl font-display font-bold mb-4" style={{ color: isDark ? '#C8E6FA' : '#0e3a6c' }}>
                    Objetivo
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-lg leading-relaxed" style={{ color: isDark ? '#E5F6FF' : '#0e3a6c' }}>
        ...
        {/* Status Badge */}
        <div className={`w-full text-center p-12 md:py-16 ${
          isDark 
            ? "bg-white/5" 
            : "bg-white"
        }`}>
